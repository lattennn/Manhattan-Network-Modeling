...
#include <string.h>
#include <omnetpp.h>
#include "l1t1bMsg_m.h"

using namespace omnetpp;


class l1t1b : public cSimpleModule
{
  private:
  ...
  protected:
    virtual l1t1bMsg *generateMessage();
    //Function for message generation.
    virtual void forwardMessage(l1t1bMsg *msg);
...
void l1t1b::initialize()
{
    ...
    if (getIndex() == 0) {
        ...
        // collected.
        l1t1bMsg *msg = generateMessage();
        scheduleAt(0.0, msg);
        numSent++; //Increase the number of messages sent by 0.
    }
}

void l1t1b::handleMessage(cMessage *msg)
{
    l1t1bMsg *ttmsg = check_and_cast<l1t1bMsg *>(msg);
    ...
    if (ttmsg->getDestination() == getIndex()) {
        ...
        l1t1bMsg *newmsg = generateMessage(); // Generation.
        EV << newmsg << endl;
...
l1t1bMsg *l1t1b::generateMessage()
{
    ...
    l1t1bMsg *msg = new l1t1bMsg(msgname);
    msg->setSource(src);
    msg->setDestination(dest);
    return msg;// Return object to calling module.
}

void l1t1b::forwardMessage(l1t1bMsg *msg)
{
